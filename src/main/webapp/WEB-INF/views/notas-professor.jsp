    ...
    <div id="conteudo">
        ...
        <div class="view-notas">
            <table>
                ...
                %>
                <tr>
                    <td colspan="6" style="text-align: center; padding: 20px;">Nenhuma nota lançada em suas turmas.</td>
                </tr>
                <% } %>
                </tbody>
            </table>
...
<div id="modal-overlay">
    <div class="modal">
        ...
        <form action="${pageContext.request.contextPath}/nota-<%= "update".equals(modalAtivo) ? "update" : "create" %>"
              method="post">
