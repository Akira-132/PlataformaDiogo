        ...
        <div class="view-notas">
            <table>
                ...
                <tr>
                    ...
                    <td><span class="nota <%= (n.getNota() < 6.0) ? "baixa" : "" %>"><%= String.format("%.1f", n.getNota()) %></span></td>
                    <td style="display: flex; gap: 10px; justify-content: center;">
                        <a href="${pageContext.request.contextPath}/nota-read?acao=prepararUpdate&id=<%= n.getId() %>">
                            <img src="${pageContext.request.contextPath}/assets/imgs/icone-editar.png" alt="Editar" class="icone-editar" />
                        </a>
                        <form action="${pageContext.request.contextPath}/nota-delete" method="post">
                            <input type="hidden" name="id" value="<%= n.getId() %>" />
                            <input type="image" src="${pageContext.request.contextPath}/assets/imgs/icone-lixeira.png" alt="Excluir"
                                   class="icone-lixeira" onclick="return confirm('Apagar esta nota?');" />
                        </form>
                    </td>
                </tr>
                <%
                ...
                %>
                <tr>
                    <td colspan="7" style="text-align: center;">Nenhuma nota lançada.</td>
                </tr>
                <% } %>
                </tbody>
            </table>
...
<div id="modal-overlay">
    <div class="modal">
        ...
        <form action="${pageContext.request.contextPath}/nota-<%= "update".equals(modalAtivo)
            ...
            <div class="modal-campos">
                            ...
                            <%
                                if (listaDisciplinas != null) {
                                    for (Disciplina d : listaDisciplinas) {
                                        boolean selecionado = (notaModal != null
                                                && notaModal.getFkDisciplinaId() == d.getId());
                            %>
                ...
                <div class="modal-campo">
                    <label for="tipo">Tipo (Ex: N1, N2)</label>
                    <div class="input-content">
                        <input type="text" name="tipo" id="tipo" value="<%= (notaModal != null)
                                ? notaModal.getTipo() : "" %>" required />
                    </div>
                </div>
                ...
                <div class="modal-campo">
                    ...
                    <div class="input-content">
                        <input type="number" name="semestre" id="semestre" value="<%= (notaModal != null)
                                ? notaModal.getSemestre() : "" %>" required />
                    </div>
                </div>
                ...
                <div class="modal-campo">
                    ...
                    <div class="input-content">
                        <input type="number" name="ano" id="ano" value="<%= (notaModal != null)
                                ? notaModal.getAno() : "" %>" required />
                    </div>
                </div>
                ...
                <div class="modal-campo">
                    ...
                    <div class="input-content">
                        <input type="text" name="nota" id="nota" value="<%= (notaModal != null)
                                ? notaModal.getNota() : "" %>" required />
                    </div>
                </div>
            </div>

            <div class="modal-botoes">
                <a href="${pageContext.request.contextPath}/nota-read" id="btn-cancelar" style="text-decoration: none; color: white;">Cancelar</a>
