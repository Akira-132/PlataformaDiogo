...
List<TurmaAluno> listaAlunos = (List<TurmaAluno>) request.getAttribute("listaAlunos");
    ...
    <aside>
        ...
        <nav>
            <a href="turmasProfessor.jsp" class="ativo">
    ...
    <main>
        ...
        <div id="conteudo">
            ...
            <a href="notasProfessor.jsp"><button>NOTAS</button></a>
            ...
            <div id="alunos-lista">
                ...
                %>
                <p style="text-align: center; color: white;">Nenhum aluno matriculado nesta turma.</p>
                <% } %>
            </div>
